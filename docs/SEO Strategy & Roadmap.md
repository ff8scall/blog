# 🔍 blog.lego-sia.com 검색 유입 극대화 SEO 전략 보고서

본 문서는 `blog.lego-sia.com`의 검색 엔진 노출(SEO)을 최적화하여 오가닉 유입을 극대화하기 위한 전문가용 가이드입니다. 

## 1. 도메인 및 URL 아키텍처 (Technical SEO)

### 1.1 서브도메인 브랜드 강화
*   **도메인**: `blog.lego-sia.com` 
*   **전략**: 메인 서비스(`lego-sia.com`)의 브랜드 지수를 공유하면서 블로그 전문성을 강조하기 위해 서브도메인을 유지합니다. 전 구간 **HTTPS** 적용은 필수입니다.
...
### 2.2 메타 태그 최적화
*   **Title Tag**: `[포스트 제목] | blog.lego-sia.com` 또는 `[포스트 제목] - 캠핑과 라이프스타일` (60자 이내).
