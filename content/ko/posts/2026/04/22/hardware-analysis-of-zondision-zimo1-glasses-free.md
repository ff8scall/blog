...
date: "2026-04-22T10:58:01+09:00"
...
### 단순 입체를 넘어선 '라이트필드'의 정점

존디시온의 ZIMO1은 기존의 3D 디스플레이가 가졌던 한계를 정밀한 '광시야각 라이트필드(Light-field) 기술'로 극복했습니다. 일반적인 무안경 3D가 좌우 두 개의 시점만을 제공하는 단순 스테레오스코픽 방식인 것과 달리, ZIMO1은 빛의 방향성을 조절하여 다수의 시야 원뿔(View-cones)을 형성합니다. 이를 통해 사용자가 고개를 움직여도 상이 깨지지 않고 자연스러운 입체감을 유지할 수 있으며, 실제 사물을 바라보는 것과 유사한 시각적 경험을 제공합니다.
